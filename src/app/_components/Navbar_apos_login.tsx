...
export default function Navbar_apos_login() {
  ...
  const links = [
    { href: "/inicio#home", label: "HOME" },
    { href: "/inicio#categories", label: "CATEGORIAS" },
  ];
  ...
  return (
    <header className="steam-header sticky top-0 z-50 shadow-sm">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <a href="#" className="w-11 h-11 rounded-full bg-gray-300 block"></a>
        </div>
